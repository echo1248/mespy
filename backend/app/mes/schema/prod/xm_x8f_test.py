...
class XMX8FTestSchemaBase(SchemaBase):
    """x8f产品基础模型"""
...
class CreateXMX8FTestParam(XMX8FTestSchemaBase):
    """创建x8f产品测试参数"""


class UpdateXMX8FTestParam(XMX8FTestSchemaBase):
    """更新x8f产品测试参数"""


class DeleteXMX8FTestParam(SchemaBase):
    """删除x8f产品测试参数"""

    pks: list[int] = Field(description='ID列表')


class GetXMX8FTestDetail(XMX8FTestSchemaBase):
    """x8f产品测试详情"""
