...
class XMX4BTestSchemaBase(SchemaBase):
    """x4b产品基础模型"""
...
class CreateXMX4BTestParam(XMX4BTestSchemaBase):
    """创建x4b产品测试参数"""


class UpdateXMX4BTestParam(XMX4BTestSchemaBase):
    """更新x4b产品测试参数"""


class DeleteXMX4BTestParam(SchemaBase):
    """删除x4b产品测试参数"""

    pks: list[int] = Field(description='ID列表')


class GetXMX4BTestDetail(XMX4BTestSchemaBase):
    """x4b产品测试详情"""
