...
class XMOH11TestSchemaBase(SchemaBase):
    """oh11产品基础模型"""
    ...
    test_meshmac: str | None = Field(default=None, description='Mesh MAC地址')
...
class CreateXMOH11TestParam(XMOH11TestSchemaBase):
    """创建oh11产品测试参数"""


class UpdateXMOH11TestParam(XMOH11TestSchemaBase):
    """更新oh11产品测试参数"""


class DeleteXMOH11TestParam(SchemaBase):
    """删除oh11产品测试参数"""

    pks: list[int] = Field(description='ID列表')


class GetXMOH11TestDetail(XMOH11TestSchemaBase):
    """oh11产品测试详情"""
