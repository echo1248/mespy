...
class JRJM03TestSchemaBase(SchemaBase):
    """jm03产品基础模型"""
    ...
    test_times_putin: int = Field(default=1, description='BMES成品标识')
...
class CreateJRJM03TestParam(JRJM03TestSchemaBase):
    """创建jm03产品测试参数"""


class UpdateJRJM03TestParam(JRJM03TestSchemaBase):
    """更新jm03产品测试参数"""


class DeleteJRJM03TestParam(SchemaBase):
    """删除jm03产品测试参数"""

    pks: list[int] = Field(description='ID列表')


class GetJRJM03TestDetail(JRJM03TestSchemaBase):
    """jm03产品测试详情"""
