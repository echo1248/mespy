...
class XMXHBTestSchemaBase(SchemaBase):
    """xhb产品测试基础模型"""
...
class CreateXMXHBTestParam(XMXHBTestSchemaBase):
    """创建xhb产品测试参数"""


class UpdateXMXHBTestParam(XMXHBTestSchemaBase):
    """更新xhb产品测试参数"""


class DeleteXMXHBTestParam(SchemaBase):
    """删除xhb产品测试参数"""

    pks: list[int] = Field(description='ID列表')


class GetXMXHBTestDetail(XMXHBTestSchemaBase):
    """xhb产品测试详情"""
