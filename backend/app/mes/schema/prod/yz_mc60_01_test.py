...
class YZMC6001TestSchemaBase(SchemaBase):
    """yz_mc60_01产品基础模型"""
...
class CreateYZMC6001TestParam(YZMC6001TestSchemaBase):
    """创建yz_mc60_01产品测试参数"""


class UpdateYZMC6001TestParam(YZMC6001TestSchemaBase):
    """更新yz_mc60_01产品测试参数"""


class DeleteYZMC6001TestParam(SchemaBase):
    """删除yz_mc60_01产品测试参数"""

    pks: list[int] = Field(description='ID列表')


class GetYZMC6001TestDetail(YZMC6001TestSchemaBase):
    """yz_mc60_01产品测试详情"""
