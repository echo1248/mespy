...
class XMOH3RTestSchemaBase(SchemaBase):
    """oh3r产品基础模型"""
    ...
    test_times_putin: int | None = Field(default=None, description='投入次数')
...
class CreateXMOH3RTestParam(XMOH3RTestSchemaBase):
    """创建oh3r产品测试参数"""


class UpdateXMOH3RTestParam(XMOH3RTestSchemaBase):
    """更新oh3r产品测试参数"""


class DeleteXMOH3RTestParam(SchemaBase):
    """删除oh3r产品测试参数"""

    pks: list[int] = Field(description='ID列表')


class GetXMOH3RTestDetail(XMOH3RTestSchemaBase):
    """oh3r产品测试详情"""
