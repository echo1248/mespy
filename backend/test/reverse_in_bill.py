...
def test_reverse_in_bill():
    """测试入库单冲销接口"""

    # 接口配置
    url = "http://mes.jiqid.net/api/v1/mes/dy/pallet/reverse_in_bill"
    headers = {
    ...
    try:
        ...
        if response.status_code == 200:
            ...
            print(f"❌ 入库单冲销失败，状态码: {response.status_code}")
